                ...
                <div class="row">
                    <div class="col-xs-12 col-md-12 text-center">
                      ...
                      if ($compta){?>
                        ...
                        <a href="index.php?uc=suivreFrais&action=selectionnerFiche" class="btn btn-primary btn-lg" role="button"><span class="glyphicon glyphicon-list-alt"></span> <br/>Suivre paiement fiches de frais</a>
                <?php }
                      else {?>
